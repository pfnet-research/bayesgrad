"""
Copied from chainer chemistry v0.3.0
Only the difference is to add dropout function
"""
import chainer
...
class GGNNDrop(chainer.Chain):
    ...
    def __init__(self, out_dim, hidden_dim=16,
                 ...
                 weight_tying=True, dropout_ratio=0):
        super(GGNNDrop, self).__init__()
    ...
    def __call__(self, atom_array, adj):
        ...
        for step in range(self.n_layers):
            h = chainer.functions.dropout(h, ratio=self.dropout_ratio)
